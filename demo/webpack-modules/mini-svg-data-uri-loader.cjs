...
/* eslint-env node */
// Nota: require perché i Webpack Loaders sono tradizionalmente CommonJS,
...
module.exports = function (source) {
  ...
  // rimuove height e width nel svgo non fosse attivato
  source = source.replace(/ width="\d+"/, '').replace(/ height="\d+"/, '');
