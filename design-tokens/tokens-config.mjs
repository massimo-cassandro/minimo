...
const config = {
  ...
  // TODO cambiare `colorPropertiesPrefixes` in `customPropsGroups` con questa forma:
  /*
  customPropsGroups: [
    {
      name: 'COLORS',
  ...
  */
  // tutto personalizzabile dall'utente, funzionamento analogo a quello attuale di `colorPropertiesPrefixes`
  // ordine dei gruppi uguale a quello degli oggi in `customPropsGroups`
  // aggiornare commento
  // anche sample
