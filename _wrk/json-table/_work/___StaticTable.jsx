...
function StaticTable(props) {
      ...
      return (
        <tr key={idx}>
          {props.columns.map((col, i) => {
            ...
            } else if(content === 0 && !props.useZeroAltChar) {
              content = props.zeroAltChar;
              addFormatClass = false;
  ...
  return (<>
    <div className={props.wrapperClassName}>
      <table className={props.tableClassName} ref={tableRef}>
      ...
      <div className='d-flex'>
        ...
        <div className={`flex-grow-1 ${props.rightAlignClassName}`}>
          ...
          <button
            ...
            onClick={() => {
              fileDownload(
                tableToCsv(tableRef.current, props.zeroAltChar),
...
StaticTable.propTypes = {
  ...
  useZeroAltChar                : PropTypes.bool,
  zeroAltChar          : PropTypes.string,
