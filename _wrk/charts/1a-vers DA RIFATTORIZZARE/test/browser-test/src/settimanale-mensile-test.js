import { datiSettimanali } from './settimanale-mensile-dati-settimanale.js';

export function settimanaleMensileTest(cfg) {
  ...
  */
  ...
  cfg.charts.settimanaleMensile({
    ...opts,
    container: '#settimanaleMensile',
    modo: 'settimanale',
