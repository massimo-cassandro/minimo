...
// console.log('*** Variabili modificate, non aggiornare da figma ***');
// process.exit();

const source_files = [
    {default: './figma/design-tokens/unaa.light.tokens.json', dark: './figma/design-tokens/unaa.dark.tokens.json' }
  ]
